...
function Detail({ children, title, buttonFoot }) {
    return (
        <div className="font-sans w-full h-screen max-w-[480px] mx-auto flex flex-col bg-white">
            {/* Header */}
            {title && (
            ...
            {/* Content with Scroll */}
            <main className="flex-1 overflow-y-auto px-0 pb-32">
                {children}
            </main>

            {/* Fixed Bottom Checkout */}
            <div className="fixed w-full max-w-md bottom-0 left-0 right-0 mx-auto p-4 bg-gray-50 shadow-lg">
                <button
